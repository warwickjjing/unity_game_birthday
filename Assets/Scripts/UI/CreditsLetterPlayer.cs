    ...
    public sealed class CreditsLetterPlayer : MonoBehaviour
    {
        ...
        private void Awake()
        {
            if (returnButton != null)
            {
                ...
                {
                    Debug.LogWarning("[CreditsLetterPlayer] ReturnButton에 Button 컴포넌트가 없습니다!");
                }
            ...
            {
                Debug.LogWarning("[CreditsLetterPlayer] ReturnButton이 할당되지 않았습니다!");
            }
        ...
        private void EnsureButtonAndEventSystem()
        {
            if (returnButton == null)
            {
                Debug.LogWarning("[CreditsLetterPlayer] ReturnButton이 null입니다!");
                return;
            }
            ...
            {
                Debug.LogWarning("[CreditsLetterPlayer] Canvas를 찾을 수 없습니다!");
            }
            ...
            if (button != null)
            {
                ...
                {
                    Debug.LogWarning("[CreditsLetterPlayer] ReturnButton에 Image 컴포넌트가 없습니다! 버튼이 클릭되지 않을 수 있습니다.");
                }
            }
            else
            {
                Debug.LogError("[CreditsLetterPlayer] ReturnButton에 Button 컴포넌트가 없습니다!");
            }
        }
        ...
        private void OnReturnButtonClicked()
        {
            ...
            {
                Debug.LogError("[CreditsLetterPlayer] SceneLoader를 찾을 수 없습니다!");
            }
        }
    }
}
